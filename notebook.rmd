...
# line from brett: bwa mem -t 4 -M -R '{params.rg}' {input.fa} {input.fq} > {output.sam}
 # idk what params.rg is, think it has to do with read group name and output sequence ID's .... lets see what happens if i skip
 # I think the input.fa is the reference, and I can put 2 paired read files as file1.fq file 2.fq back to back
bwa mem -t 4 -M ../../sarscov2WuhanHu1.fasta *R1_001.bbduk.fastq.gz *R2_001.bbduk.fastq.gz > GSR_SWIFT_2021_04_06_O20_001_020821_C1E1_S14.sam
```
