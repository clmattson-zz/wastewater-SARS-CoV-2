...
(osu) cmatt5@c2-18:/group/diazmunozlab/share/NextSeq_Environmental_Batch1$ for i in ./*R1_001.bbduk.fastq.gz;
do bn=$(basename $i R1_001.bbduk.fastq.gz); 
minimap2 -ax sr -t 4 -o ${bn}.sam ~/SARS-COV2/sarscov2WuhanHu1.fasta ${bn}R1_001.bbduk.fastq.gz ${bn}R2_001.bbduk.fastq.gz | samtools sort | samtools view -F 4 -o ${bn}.bbduk.mmp.sorted.bam;
done

#code above converts sam to sorted bam. 
#switch to ivar conda env
...
samtools mpileup -aa -A -d 0 -B -Q 0 --reference ~/SARS-COV2/sarscov2WuhanHu1.fasta ${bn}.bbduk.mmp.sorted.ivar.sorted.bam | ivar variants -p "${bn}.variants" -r ~/SARS-COV2/sarscov2WuhanHu1.fasta -g ~/SARS-COV2/ivar/GCF_009858895.2_ASM985889v3_genomic.gff; 
done
